...
/// \fn int get_int(int*, int, char*, char*, int, int, int, int)
...
int get_int(int *pResultado, int len, char *mensaje, char *mensajeError,
...
/// \fn int get_float(float*, int, char*, char*, int, int, int, int)
...
int get_float(float *pResultado, int len, char *mensaje, char *mensajeError,
		int minimo, int maximo, int reintentos, int flagSigned) {
	int retorno = -1;
	char buffer[len];
	float bufferFloat;
...
/// \fn int get_name(char*, int, char*, char*, int)
...
int get_name(char *pResultado, int len, char *mensaje, char *mensajeError,
		int reintentos) {
	int retorno = -2;
	char buffer[len];
	if (pResultado != NULL && len > 0 && mensaje != NULL && mensajeError != NULL
...
/// \fn int get_text(char*, int, char*, char*, int)
...
int get_text(char *pResultado, int len, char *mensaje, char *mensajeError,
		int reintentos) {
	int retorno = -1;
	char buffer[len];
...
/// \fn int get_dni(char*, char*, char*, int)
/// \brief Pide un dni
...
/// \fn int get_cuit(char*, char*, char*, int)
/// \brief Pide un cuit
...
int get_cuit(char *pResultado, char *mensaje, char *mensajeError,
		int reintentos) {
	int retorno = -2;

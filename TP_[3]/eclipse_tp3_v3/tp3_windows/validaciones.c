...
/// \fn int val_isValidInt(char*, int)
/// \brief Indica si un string es un numero entero
/// \param numero Puntero a la dirección de memoria del string con el supuesto numero
...
/// \fn int val_isValidFloat(char*, int)
...
/// \fn int val_isValidName(char*)
/// \brief Indica si un string es un nombre valido
/// \param nombre Puntero a la dirección de memoria del string con el supuesto nombre
...
/// \fn int val_isValidDni(char*)
/// \brief Indica si un string es un dni valido
/// \param dni Puntero a la dirección de memoria del string con el supuesto dni
...
/// \fn int val_isValidTelefono(char*)
/// \brief Indica si un string es un telefono valido
/// \param telefono Puntero a la dirección de memoria del string con el supuesto telefono
...
/// \fn int val_isValidTarjeta(char*)
/// \brief Indica si un string es una tarjeta valido
/// \param tarjeta Puntero a la dirección de memoria del string con la supuesta tarjeta
...
/// \fn int val_isValidCuit(char*)
/// \brief Indica si un string es un cuit valido
/// \param cuit Puntero a la dirección de memoria del string con el supuesto cuit
...
/// \fn int val_cantidadDigitos(char*)
/// \brief Indica si la cantidad de digitos ingresados esta bien o mal
/// \param arrayParaVerificar Puntero a la dirección de memoria del string con los digitos
...
/// \fn int val_isValidEmail(char*)
/// \brief Indica si un string es un mail valido
/// \param email Puntero a la dirección de memoria del string con el supuesto mail
